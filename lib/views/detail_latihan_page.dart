...
class _DetailLatihanPageState extends State<DetailLatihanPage> {
  ...
  String getImagePath(String level) {
    switch (level) {
      case "Noob":
        return "assets/images/pemula.png";
      case "Pro":
        return "assets/images/menengah.png";
      case "Hacker":
        return "assets/images/lanjutan.png";
      default:
        return "assets/images/pemula.png";
    }
  }
      ...
      body: Column(
        children: [
          ...
          Container(
            ...
            height:
                screenHeight * 0.28, // Sedikit lebih tinggi agar gambar muat
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          _buildInfoItem(
                            "Latihan",
                            "${paket.movements.length}",
                          ),
                          _buildInfoItem(
                            "Durasi",
                            "${getTotalDuration(paket)} mnt",
                          ),
                          _buildInfoItem(
                            "Kalori",
                            "${getCalories(paket)} kkal",
                          ),
                        ],
                      ),
                    ),
    ...
    return GestureDetector(
      onTap: () {
        showModalBottomSheet(
          ...
          backgroundColor: Colors.transparent,
          builder: (_) => ExercisePreviewSheet(movementName: m.name),
        );
      },
      child: Container(
